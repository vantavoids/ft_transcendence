...
/// <summary>
/// covers the channel-aware <c>PermissionResolver.Resolve(Guild, long, IReadOnlyList&lt;ChannelPermissionOverwrite&gt;)</c>
...
public sealed class ChannelPermissionResolverTests
{
	...
	public void Owner_GetsAllBits_RegardlessOfRoles()
	{
		...
		var mask = PermissionResolver.Resolve(
			guild, userId: 42, overwrites: Array.Empty<ChannelPermissionOverwrite>());
	...
	public void NonMember_ReturnsZero()
	{
		...
		var mask = PermissionResolver.Resolve(
			guild, userId: 999, overwrites: Array.Empty<ChannelPermissionOverwrite>());
	...
	public void Member_OnlyEveryoneRole_GetsEveryoneMask()
	{
		...
		var mask = PermissionResolver.Resolve(
			guild, userId: 2, overwrites: Array.Empty<ChannelPermissionOverwrite>());
	...
	public void RoleOverwrites_TwoRolesAllowingSameBit_BitIsGrantedNotXored()
	{
		...
		var mask = PermissionResolver.Resolve(
			guild, userId: 2, overwrites: new[] { ow1, ow2 });
	...
	public void OverwritesForOtherRoles_AreIgnored()
	{
		...
		var mask = PermissionResolver.Resolve(
			guild, userId: 2, overwrites: new[] { ow });
	...
	public void MemberOverwrite_NotPickedUpByRoleOverwriteWithMatchingTargetId()
	{
		...
		var mask = PermissionResolver.Resolve(
			guild, userId: 2, overwrites: new[] { roleOw });
