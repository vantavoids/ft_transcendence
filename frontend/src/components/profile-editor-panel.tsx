...
export function ProfileEditorPanel({
  ...
  return (
    <div className="grid w-full min-w-0 gap-4 xl:grid-cols-[18rem_minmax(0,1fr)] xl:items-start">
      <div
        className="w-full overflow-hidden rounded-[1rem] border border-white/8 bg-panel xl:sticky xl:top-0"
        style={
      ...
      >
        <div className="flex flex-col gap-4 bg-[linear-gradient(135deg,rgba(18,18,24,0.65),rgba(18,18,24,0.2))] px-4 py-4">
